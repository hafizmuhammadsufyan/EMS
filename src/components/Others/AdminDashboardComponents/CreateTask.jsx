                ...
                <form onSubmit={(e) => { taskCreator(e) }} className='flex gap-4 flex-wrap py-4 px-6 shadow-[0px_10px_12px_gray] rounded-2xl items-start justify-between border-t-2 border-amber-500'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <input
                            ...
                            value={title}
                            className='border-b-2 outline-none border-b-amber-500 rounded py-1 px-3'
                            type="text"
                        ...
                        <input
                            ...
                            className='border-b-2 outline-none border-b-amber-500 rounded py-1 px-3'
                            type="text"
                            placeholder='Employee ID (1/ 2/ 3 etc..)' />
                        <h3>Category</h3>
                        <input
                            required
                    ...
                    <div className='flex flex-col gap-4'>
                        <textarea
                            ...
                            className='border-b-2 outline-none border-b-amber-500 rounded py-1 px-3 lg:w-70 w-full h-40'>
                        </textarea>
