...
const TaskOverviewCards = () => {
    return (
        <div className='flex gap-4'>
            <div className='bg-purple-500 text-white w-[25%] py-4 px-3 rounded-2xl shadow-xl mt-6'>
            ...
            <div className='bg-green-500 text-white w-[25%] py-4 px-3 rounded-2xl shadow-xl mt-6'>
                <div className='flex items-center justify-between mb-3'>
            ...
            <div className='bg-pink-600 text-white w-[25%] py-4 px-3 rounded-2xl shadow-xl mt-6'>
                <div className='flex items-center justify-between mb-3'>
            ...
            <div className='bg-red-500 text-white w-[25%] py-4 px-3 rounded-2xl shadow-xl mt-6'>
                <div className='flex items-center justify-between mb-3'>
