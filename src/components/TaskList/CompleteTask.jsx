...
const CompleteTask = ({data}) => {
    return (
        <div className='lg:w-[20vw] w-full flex flex-col justify-between bg-green-400 shrink-0 rounded-xl pt-4 pb-8 px-3 '>
            ...
            <div>
                <button className='bg-green-600 text-lg font-bold py-0.5 w-full rounded mt-6'>Completed</button>
            </div>
        </div>
    )
}
